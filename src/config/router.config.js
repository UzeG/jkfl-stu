...
import { UserLayout, BasicLayout, RouteView, BlankLayout, PageView, BookLayout } from '../layouts'
...
export const constantRouterMap = [
  ...
  // book
  {
    ...
    name: 'user-book-library',
    meta: { title: '在线阅读', keepAlive: true, icon: 'book', permission: ['user-book-library'] },
    children: [
      {
        path: '/book',
        name: 'user-book-library',
        component: () => import('../views/book/user-book-library')
      },
      {
        path: '/book/book-read/:id/:type',
        name: 'user-book-read',
        component: () => import('../views/book/user-book-read')
      },
      {
        path: '/book/book-market',
        name: 'user-book-market',
        component: () => import('../views/book/user-book-market')
      }
    ]
  }
]
